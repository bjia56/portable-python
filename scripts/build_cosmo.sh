...
CC="aarch64-unknown-cosmo-cc" AR="aarch64-unknown-cosmo-ar" LDFLAGS="-L${DEPSDIR}/lib/.aarch64" ./configure --disable-asm --disable-shared --host=aarch64 --prefix=${DEPSDIR}
make -j4
make install
install_license ./COPYING.LIB
